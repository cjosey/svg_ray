"""
Calculates a spectrum for weighting a given sRGB coordinate
"""
function spec_weight(rgb)
    ...
    # Then, define the spectrum to XYZ matrix
    # Uses data from:
    ...
    # Apply pseudo inverse to get approximate color-matched spectrum
    pseudo_inv = pinv(cie_color_match)
    data = pseudo_inv * xyz
